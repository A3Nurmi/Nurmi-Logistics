...
[
    ...
    ["STR_NL_CBA_Category_Main" call BIS_fnc_localize, "STR_NL_CBA_Category_General" call BIS_fnc_localize], // Category for the settings menu + optional sub-category <STRING, ARRAY>
